...
public interface UsageRecordRepository extends MongoRepository<UsageRecord, String> {
    ...
    UsageRecord findByUserIdAndTimestamp (String userId, String timestamp);

    UsageRecord findByUserIdAndApp (String userId, String app);
    UsageRecord findByUserIdAndAppAndTimestamp (String userId, String app, String timestamp);
}
